 ...
 * }
 */
function buildShiftDateContext(
  work_date,
  shift,
  settings
) {
  ...
  return {
    ...
    overnight:
      shiftWindow.overnight,

    scheduled_minutes:
      shiftWindow.scheduled_minutes,

    shift_start_utc:
      shiftWindow.shift_start,

    shift_end_utc:
      shiftWindow.shift_end,
 ...
 */
function buildDisplayAttendance(
  attendance,
  shiftContext
) {

  const timezone =
    shiftContext.timezone;
  ...
  return {
    ...
    shift_name:
      shiftContext.shift_name,

    shift_range:
      shiftContext.shift_range,

    scheduled_minutes:
      shiftContext.scheduled_minutes,
    ...
    shift_start:
      shiftContext.shift_start_local,

    shift_end:
      shiftContext.shift_end_local,
    ...
    debug: {
      ...
      shift_start_utc:
        shiftContext.shift_start_utc,

      shift_end_utc:
        shiftContext.shift_end_utc,
